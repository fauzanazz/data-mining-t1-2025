...
class AprioriAlgorithm(Algorithm):
    """Apriori algorithm for frequent itemset mining.

    Uses the mlxtend library for efficient implementation while
    conforming to the Algorithm interface.

    Example:
        >>> algo = AprioriAlgorithm(min_support=0.05, min_confidence=0.6)
